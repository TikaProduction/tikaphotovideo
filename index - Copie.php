...
@media all and (min-width: 320px) and (max-width: 835px) {
    ...
    <body  onload="myFunction()">
        ...
        <main>
                ...
                <div class="container mb-5 pb-lg-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mt-lg-3 mb-lg-5">
                            <p data-aos="fade-up" data-aos-delay="500"> Que ce soit une séance photo, un tournage ou un montage vidéo, je m'efforce de capturer l'émotion et l'énergie de chaque situation.</p>
                        </div>

                        <div class="col-lg-6 col-12 mt-3 mb-lg-5">
                            <p class="me-4" data-aos="fade-up" data-aos-delay="300">La collaboration est au cœur de mon approche. Je considère chaque client comme un partenaire, et il est essentiel pour moi de comprendre leurs besoins, leurs attentes et leur vision. Mon objectif est de créer un espace où chacun se sent à l'aise pour s'exprimer, afin que nous puissions travailler ensemble à la création de contenu authentique et engageant..<br>
                            ...
                            <a rel="nofollow" href="https://templatemo.com/tm-567-nomad-force" target="_parent">En fonctions de vos retours</a>
                             et être la plus réactive, possible. Cela nous aidera à être le plus efficiant, possible. <br><br>Alors, parlons de votre projet.</p>
                        </div>
            ...
            <h2 class="mb-5 text-center" data-aos="fade-up">Mes projets vidéos</h2>
                <div class="container text-center"><br><br><a href="videos.html"><img class="img-fluid" src="images\lifestyle.JPG" style="width:600px;"><p class="bg-warning text-light text-center justify-content-center bt-cat" >Voir mes projets</p></a></div>
            </section>
            ...
            <section class="section-padding" id="portfolio">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5 text-center" data-aos="fade-up">Photographie</h2>
                            <div class="container text-center"><br><br><a href="photos.html"><img class="img-fluid" src="images\001_photo-culinaire-studio.JPG" style="width:600px;"><p class="bg-warning text-light text-center bt-cat" >Voir mes photos</p></a></div>
            ...
            <section class="news section-padding" id="news">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h2 class="mb-5 text-center" data-aos="fade-up">Mes Workflows</h2>
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="news-thumb" data-aos="fade-up">
                                ...
                                <div class="news-text-info">
                                    <h5 class="news-title">
                                        <a href="news-detail.html" class="news-title-link">Documentaire, court métrage, branding</a>
                                    </h5>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="news-thumb news-two-column d-flex flex-column flex-lg-row" data-aos="fade-up">
                                ...
                                <div class="news-bottom w-100">
                                    <div class="news-text-info">
                                        <h5 class="news-title">
                                            <a href="news-detail.html" class="news-title-link">Studio photo, Portrait et branding</a>
                                        </h5>
                            ...
                            <div class="news-thumb news-two-column d-flex flex-column flex-lg-row" data-aos="fade-up">
                                ...
                                <div class="news-bottom w-100">
                                    <div class="news-text-info">
                                        <h5 class="news-title">
                                            <a href="news-detail.html" class="news-title-link">Reportage, plateau de tounage</a>
                                        </h5>
